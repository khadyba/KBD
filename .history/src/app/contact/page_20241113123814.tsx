                    ...
                    <div className="bg-[#D5AF4F] w-full max-w-[500px] flex flex-col justify-center items-center text-center rounded-[20px] p-6">
                        ...
                        <form onSubmit={handleSendContactForm} className="space-y-4 w-full px-4">
                            <input
                                type="text"
                                placeholder="Nom"
                                className="w-full p-3 rounded-[10px] bg-[#F1F8F9] focus:outline-none"
                                required
                            />
                            <input
                                type="email"
                                placeholder="E-mail"
                                className="w-full p-3 rounded-[0px] bg-[#F1F8F9] focus:outline-none"
                                required
                            />
                            <textarea
                                placeholder="Message"
                                className="w-full p-3 rounded-[20px] bg-[#F1F8F9] focus:outline-none"
                                rows={4}
                                required
                            />
                            <button
                                type="submit"
                                className="w-full p-3 bg-[#F1F8F9] text-[#D5AF4F] font-bold rounded-[20px] hover:bg-[#e0d0a3] transition-colors"
                            >
                                Envoyer
                            </button>
                        </form>
