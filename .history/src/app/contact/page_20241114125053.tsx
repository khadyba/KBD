            ...
            <div className="flex flex-col lg:flex-row gap-10 justify-center items-start w-full h-full">
                ...
                <div className="bg-[#EDD9A3] rounded-[20px] p-8 shadow-md flex flex-col items-center justify-center w-full max-w-[500px] min-h-[485px] h-full">
                    ...
                    <div className="h-[400px] w-full max-w-[500px]">
                                    ...
                                    <div className="text-[#F5D67D] bg-white w-full p-6 flex flex-col gap-6 items-center justify-center rounded-b-[10px] h-[350px]">

                                        <div className="text-[20px] space-y-4 text-center">

                                            <div className="flex items-center justify-center gap-3 space-x-10">
                                                <Image 
                                                    src="/Phone.svg"
                                                    ...
                                                    height={30}
                                                />
                                               <Link><span>77 000 00 00</span></Link>
                                            </div>
                                            <div className="flex items-center justify-center gap-3 space-x-10">
                                                <Image 
                                                    src="/Location.svg"
