...
<div className="flex flex-col lg:flex-row gap-10 justify-center items-start w-full">
    ...
    <div className="bg-[#EDD9A3] rounded-[20px] shadow-md flex items-center justify-center p-8 min-h-[600px] w-full lg:w-1/2">
        <div className="bg-[#D5AF4F] w-full max-w-full flex flex-col justify-center items-center text-center rounded-[20px] p-6">
    ...
    <div className="bg-[#EDD9A3] rounded-[20px] p-8 shadow-md flex flex-col items-center justify-center w-full lg:w-1/2 min-h-[600px]">
        ...
        <div className="text-[#F5D67D] bg-white w-full p-6 flex flex-col gap-4 items-center rounded-b-[10px]">
