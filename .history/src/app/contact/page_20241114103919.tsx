...
<div className="bg-[#EDD9A3] rounded-[20px] shadow-md flex items-center justify-center p-8 min-h-[400px]">
...
<div className="bg-[#EDD9A3] rounded-[20px] p-8 shadow-md flex flex-col items-center justify-center w-full max-w-[500px] min-h-[485px]">
    <div className="bg-[#D5AF4F] w-full rounded-t-[10px] py-2">
