    ...
    return (
        <section className="py-12 w-full lg:px-24 flex flex-col items-center">
            ...
            <div className="flex flex-col lg:flex-row gap-10 justify-center items-start w-full">
                ...
                <div className="bg-[#EDD9A3] rounded-[20px] p-8 lg:w-1/2 shadow-md text-center  items-center justify-center ">

                          <div className="bg-[#D5AF4F] w-full max-w-[500px]">
                              <h2 className="text-white font-bold ext-[20px] ">Contactez-moi</h2>
                          </div>
                      

                            <div className="text-[#F5D67D] bg-white w-full max-w-[500px]  flex flex-col justify-center items-center text-center  ">
