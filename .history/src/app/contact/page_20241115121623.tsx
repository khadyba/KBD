    ...
    return (
        <section className="py-12 w-full lg:px-24 flex flex-col items-center">
            ...
            <div className="flex flex-col lg:flex-row gap-10 justify-center items-start w-full h-full">
               ...
               {/* Contact Information */}
<div className="bg-[#EDD9A3] rounded-[20px] p-8 shadow-md flex items-center justify-center w-full max-w-[500px] min-h-[485px] h-full">
    <div className="w-full max-w-[500px]">
        ...
        <div className="text-[#F5D67D] bg-white w-full p-8 flex flex-col gap-6 items-center rounded-b-[10px] h-[350px]">
            <div className="text-[18px] space-y-4 text-center">
                {/* Phone */}
