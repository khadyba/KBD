    ...
    return (
        <section className="py-12 w-full lg:px-24 flex flex-col items-center">
            ...
            <div className="flex flex-col lg:flex-row gap-10 justify-center items-start w-full">
                ...
                <div className="bg-[#EDD9A3] rounded-[20px] p-8 lg:w-1/2 shadow-md flex flex-col items-center justify-center <div className="bg-[#EDD9A3] rounded-[20px] p-8 lg:w-1/2 shadow-md flex flex-col items-center justify-center">
