              ...
              <div className="flex justify-center items-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 space-x-10 gap-8 md:gap-8 max-w-[1200px]">
                 ...
                 >
                   ...
                   <h2 className="text-xl text-[20px] font-bold  text-white mt-6">
                     {article.title}
                   </h2>
                   {/* Image centrée */}
                   <div className="flex justify-center items-center ">
                     {article.image && (
                      ...
                      <div className="flex justify-end mt-4 mr-10 ">
                        <a
                          ...
                          className="bg-white text-[#D5AF4F] text font-medium py-2 px-6 rounded-[10px] hover:bg-[#eee1be] w-[150px]"
                        >
                          Voir plus
                        </a>
                      </div>
