    ...
    <section className="py-10">
            ...
            {articles.length === 0 && !error ? (
              ...
              <div className="flex justify-center items-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 space-x-8 gap-8 md:gap-8 max-w-[1200px]">
                  {visibleArticles.map((article) => (
                    ...
                    >
                      ...
                      <h2 className="text-xl font-semibold  text-left text-white">{article.title}</h2>
                      ...
                      <div className="flex justify-end mt-auto mr-10">
                        <a
            ...
            <div className="flex justify-center mt-10">
              {Array.from({ length: Math.ceil(articles.length / articlesPerPage) }, (_, index) => (
                <button
                  key={index}
                  className={`h-3 w-[14px] rounded-full mx-1 ${
