...
export default function BlogPage() {
  ...
  return (
    ...
    <div className="p-8">
      <h1 className="text-3xl text-[45px] font-bold text-center mb-8 text-[#67245B]">
        Articles du blog
      </h1>
        ...
        <div className="flex justify-center items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 space-x-10 gap-8 md:gap-8 max-w-[1200px]">
            {visibleArticles.map((article) => (
              <div
                key={article.id}
                className="bg-[#D5AF4F] rounded-[20px] overflow-hidden shadow-lg p-4 flex flex-col mt-4"
                style={{ width: "600px", height: "500px" }}
              >
                {/* Titre proche de l'image */}
                <div className="mb-4">
                  <h2 className="text-xl text-[20px] font-bold text-white mb-2">
                    {article.title}
                  </h2>
                </div>
